...
# cluster.management.io/cluster-backup-operator-bundle:$VERSION and cluster.management.io/cluster-backup-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= cluster.management.io/cluster-backup-operator
...
# Produce CRDs that work with Kubernetes 1.16 (use version conversion)
...
#TODO: put back running manifests & generate-> test: manifests generate fmt vet lint ## Run tests.
