...
const (
	...
	// SchedulePhasePaused means the BackupSchedule is paused, velero schedules are not running
...
type BackupScheduleSpec struct {
	...
	// +kubebuilder:validation:Optional
	// When set to false, all velero Schedules generated by this BackupSchedule are being removed.
	// Setting this option to true results in recreating the velero Schedules.
	// If not defined, the value is set to false.
