...
type BackupScheduleSpec struct {
	...
	// +kubebuilder:validation:Optional
	// If not defined, the value is set to false.
	// Set this to true if you don't want to have backups created immediatly after the velero schedules are created
	// Keep in mind that if you chose not to create ACM backups immediatly after the schedules are genereted
	// the validation policy will show a violation until backups are generated as deifned by the cron job.
	// Also, if backups are not gerenated immediatly, the BackupSchedule will always get into a BackupCollision state
